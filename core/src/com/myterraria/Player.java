...
public class Player{
    ...
    public static void draw(SpriteBatch sb,TiledMap map){
        ...
        //HEAD
        sb.setColor(0.9875f,0.78f,0.63f,1);
        sb.draw(Assets.getTexture("head"), draw_x, draw_y,w/2f,h/2f,w,h,1,1,0,fx,fy+56*frame,fw,fh,lookside,false);
        //EYES
        sb.setColor(0.05f,0.34f,0.84f,1);
        sb.draw(Assets.getTexture("eyes"), draw_x, draw_y,w/2f,h/2f,w,h,1,1,0,fx,fy+56*frame,fw,fh,lookside,false);

        sb.setColor(1,1,1,1);
        sb.draw(Assets.getTexture("eyes2"), draw_x, draw_y,w/2f,h/2f,w,h,1,1,0,fx,fy+56*frame,fw,fh,lookside,false);
        //HAIR
        sb.setColor(0.2f,0.2f,0.2f,1);
        sb.draw(Assets.getTexture("hair1"), draw_x, draw_y,w/2f,h/2f,w,h,1,1,0,fx,fy+((animationStage==1&&frame>=6)?56*(frame-6):0),fw,fh,lookside,false);
